import { scanOutputs, scanOutputsWithTweak } from "../ts_src/scanning";
import { Buffer } from "buffer";
import { testData, scanTweakVectors } from "./fixtures/scanning";
import { LabelMap } from "../ts_src/interface";
...
describe("Scanning", () => {
  ...
  it.each(scanTweakVectors)(
    ...
    ({ scanPrivateKey, spendPublicKey, tweak, outputs, expectedTweakHex }) => {
